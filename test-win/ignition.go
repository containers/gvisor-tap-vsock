...
func CreateIgnition(publicKey, ignitionUser, ignitionPasswordHash string, netPort uint64, binaryPath string, tmpDir string) (string, error) {
...
func generateUserData(publicKey, ignitionUser, ignitionPasswordHash string, netPort uint64, binaryPath string) ([]byte, error) {
	...
	addUserModeNetworking(userData, netPort)
